...
def create_diagram(title, nodes, edges, node_labels=None, node_types=None, edge_labels=None):
    ...
    pos["Translation Verification"] = (3*horizontal_spacing, 0)
    pos["Knowledge Base Lookup"] = (4*horizontal_spacing, 0)
...
def extended_uluru_exercise():
    ...
    edges = [
        ...
        ("Arrernte Language Specialist", "Translation Verification"),
        ("Pitjantjatjara Language Specialist", "Translation Verification"),
        ("Translation Verification", "Knowledge Base Lookup"),        
        ("Knowledge Base Lookup", "Translation Verification"),
        ("Translation Verification", "Arrernte Language Specialist"),
        ("Translation Verification", "Pitjantjatjara Language Specialist"),
